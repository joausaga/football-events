...
In this part of the study, I am interested in further understanding the attempt events, specially those that ended up as goals. Through the next plots I will explore the relationship between teams and attempts, goals and assitance method, goals and time, goals and body part, goals and game situation, and goals and location. Also, I will investigate the team's fair play.
...
ggplot(aes(x=reorder(team, -per_attempts), y=per_attempts, fill=team), data=teams_attempt[1:10,]) +
  geom_bar(colour="black", stat = "identity") +
...
In this section, I'll explore some characteristics of the teams' performance, like its effectiveness. By effectiveness, I mean number of goals by number of attempts. Then, I'll further investigate the attempt characteristics of the most effective team.
...
Green bubbles represent the top-10 most effective teams. The team effectiveness is specified by the size of the bubbles and in parenthesis under the team name. Let's investigate further the characteristic of Barcelona's attempt that ended up as goals (e.g., location, game situation, assitance, method).

### Barcelona's goal attempts
...
ggplot(aes(x=reorder(location,-num_goals), y=num_goals, fill=location), data=barcelona_attempts[barcelona_attempts$situation=='Open play',]) +
  geom_bar(colour="black", stat = "identity") +
  theme_economist() +
  theme(axis.text.x  = element_text(angle=90, vjust=0.5, size=10), legend.position="none") +
  facet_grid( ~ assist_method, scales="free")
```
